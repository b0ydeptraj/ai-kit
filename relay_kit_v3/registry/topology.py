...
HUB_SUPPORT_MAP = {
    ...
    "plan-hub": ["analyst", "pm", "architect", "scrum-master", "research", "market-research", "growth-marketing", "impact-radar", "token-economy", "context-continuity", "ux-structure", "mermaid-diagrams"],
    ...
    "fix-hub": ["developer", "go-service-engineering", "next-product-frontend", "execution-loop", "project-architecture", "api-integration", "data-persistence", "accessibility-review", "token-economy", "handoff-context"],
    "test-hub": ["qa-governor", "testing-patterns", "automation-ops", "vietnamese-product-localization", "execution-loop", "multimodal-evidence", "release-readiness", "accessibility-review", "skill-gauntlet", "impact-radar", "runtime-doctor", "migration-guard", "token-economy", "context-continuity", "media-tooling"],
    "review-hub": ["qa-governor", "testing-patterns", "automation-ops", "vietnamese-product-localization", "project-architecture", "doc-pointers", "memory-search", "release-readiness", "accessibility-review", "skill-gauntlet", "impact-radar", "runtime-doctor", "migration-guard", "token-economy", "context-continuity", "mermaid-diagrams"],
}
