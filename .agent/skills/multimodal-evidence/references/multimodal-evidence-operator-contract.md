# multimodal-evidence Operator Contract

Use this contract when `multimodal-evidence` is selected for Use when screenshots, diagrams, rendered UIs, or media artifacts contain important clues. Multimodal evidence utility.
...
- Produce or update these outputs: visual or media observations appended to the active artifact.
