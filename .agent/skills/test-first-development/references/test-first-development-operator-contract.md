# test-first-development Operator Contract

Use this contract when `test-first-development` is selected for Use when implementation should follow a red-green-refactor loop instead of ad-hoc coding. Test-first execution utility.
...
- Produce or update these outputs: test-first execution notes and evidence appended to story, tech-spec, or qa-report.
...
- Return through one of these next steps when the lane needs handoff: developer, test-hub, qa-governor.
