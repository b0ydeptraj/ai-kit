...
```bash
repo-map --include "docs/**,README.md,*.md" --output docs.xml
```

**3. Exclude large files:**
```bash
repo-map --exclude "*.png,*.jpg,*.pdf,*.zip,dist/**,build/**,node_modules/**" --output repo-map-output.xml
```
...
repo-map --output repo-map-output.xml
```
...
- Store repo-map output for reuse
