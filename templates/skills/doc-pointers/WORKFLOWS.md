...
This document provides comprehensive workflow examples for the doc-pointers skill.
...
→ Bash: which repo-map || npm install -g repo-map

Step 5: Clone and Process Repository
→ Bash: git clone https://github.com/org/library-name /tmp/docs-analysis
→ Bash: cd /tmp/docs-analysis && repo-map --output repo-map-output.xml

Step 6: Analyze Repomix Output
→ Read: /tmp/docs-analysis/repo-map-output.xml
