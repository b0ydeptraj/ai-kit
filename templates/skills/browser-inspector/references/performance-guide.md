...
Comprehensive guide to analyzing web performance using Chrome DevTools Protocol, Puppeteer, and browser-inspector skill.
...
### Measuring with browser-inspector-mcp
