...
cd .claude/skills/browser-inspector/scripts
...
All scripts are in `.claude/skills/browser-inspector/scripts/`
...
2. Verify in `.claude/skills/browser-inspector/scripts/` directory
3. If wrong directory, `cd` to correct location
4. Use absolute paths for all output files

Example:
```bash
pwd  # Should show: .../browser-inspector/scripts
# If wrong:
cd .claude/skills/browser-inspector/scripts
```
