...
|---|---|---|---|---|---|---|---|---|---|---|
| primary | bootstrap | workflow-router | post-query/service state refresh | live state and next-lane pointer | active | none | wave-1 | active | developer next | PR #90 merged and main CI `25621218408` passed; next implementation slice is dashboard/eval polish advanced. |
