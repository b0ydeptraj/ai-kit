...
|---|---|---|---|---|---|---|---|---|---|---|
| primary | bootstrap | workflow-router | developer | post-query/service state refresh | live state and next-lane pointer | none | wave-1 | active | runtime doctor, enterprise doctor, readiness, and PR CI | active |
