...
- Workflow eval default fixtures now cover 37 production/team scenarios and signal export should report `relay.workflow.scenario_count=37` after a fresh Pulse build.
